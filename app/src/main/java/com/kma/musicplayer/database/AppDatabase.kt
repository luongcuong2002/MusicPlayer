...
import com.kma.musicplayer.database.dao.FavouriteSongDao
...
@Database(entities = [PlaylistModel::class, HiddenSong::class, FavouriteSong::class], version = 1, exportSchema = false)
